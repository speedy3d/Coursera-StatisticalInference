...
hist(mean_data$mean, freq=FALSE, col="gray", main="Sample Distribution w/Simulated Normal Distribution Overlay", xlab="Mean")

#add the theoretical normal distribution curve on top
curve(dnorm(x, 1/lambda, (1/lambda/sqrt(n_samples))), col="red", lty=1, lwd=5, add=TRUE)
```

As we can see, the sample distribution follows the normal distribution quite nicely.
