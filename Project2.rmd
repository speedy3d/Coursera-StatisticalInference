...
```{r}
boxplot(len ~ supp * dose, data=ToothGrowth, col=(c("orange", "red")), ylab="Length of Tooth", xlab="Delivery Method and Dosage", main="Tooth Growth Data")
```
...
We will now test our hypothesis that orange juice is the superior vitamin C delivery method and results in better tooth growth than ascorbic acid in guinea pigs.
